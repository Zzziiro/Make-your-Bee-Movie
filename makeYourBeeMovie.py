bee = input("Replace Bee: ")
bees = input("Replace Bees: ")
barry = input("Replace Barry: ")
vanessa = input("Replace Vanessa: ")
adam = input("Replace Adam: ")
...
'''
print(string.replace("Barry", barry).replace("Vanessa", vanessa).replace("Adam", adam).replace("bee", bee).replace("Bee", bee).replace("BEE", bee).replace("Bees", bees).replace("bees", bees).replace("BEES", bees))